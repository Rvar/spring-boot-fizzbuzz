package com.fizzbuzz.springbootfizzbuzz.services;
...
public class FizzbuzzServices {
	 ...
	 */
	private ConcurrentHashMap<Integer, FizzBuzzHitRequest> fizzBuzzHitRequest = new ConcurrentHashMap<Integer, FizzBuzzHitRequest>();
